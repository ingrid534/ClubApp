...
export default interface CategoryDataAccessInterface {
   ...
   */
  getClubsByCatagory(categoryId: string): Promise<Club[]>;
   ...
   */
  addClubCatagory(clubId: string, categoryId: string): Promise<void>;
   ...
   */
  deleteClubCatagory(clubId: string, categoryId: string): Promise<void>;
